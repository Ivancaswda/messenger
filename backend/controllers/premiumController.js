...
const stripePayment = async (request, response) => {
    ...
    try {
        const session = await stripe.checkout.sessions.create({
            ...
            mode: "payment",
            success_url: `https://messenger-7d22.onrender.com/verify?success=true&userId=${userId}`,
            cancel_url: `https://messenger-7d22.onrender.com/verify?success=false&userId=${userId}`,
        });
